        ...
        <div class="modal__content">
                    ...
                    <form class="product-form" id="product-form" method="POST" enctype="multipart/form-data">
                        <div class="product-details-content grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="product-details-right space-y-4">
                                ...
                                <button class="product-form__file-input bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 flex justify-center items-center" id="productFormFileInput">
            ...
            <div class="modal-footer p-4 border-t">
                <div class="product-form__ctrls flex justify-between">
                    <button class="product-form__btn bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600" id="delete-btn">DELETE</button>
                    <button class="product-form__btn bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600" id="updateBtn">UPDATE</button>
                </div>
            </div>
        </div>
    </div>
