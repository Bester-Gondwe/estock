...
// Database connection (create an instance of the Database class)
$db = new Database(); // Now using an instance of the class
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($address) || empty($paymentMethod)) {
        echo "<p class='text-red-500'>Please fill in all the fields.</p>";
        exit();
    }
    ...
    try {
        ...
        $orderId = $db->getConnection()->lastInsertId(); // Use getConnection() to get PDO instance for lastInsertId()
        ...
        <body class='bg-gray-100'>
            <div class='max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md mt-12'>
                ...
                <div class='mt-6'>
                    ...
                    <div class='mt-4'>
                        <p class='text-sm text-gray-600'><span class='font-semibold'>Shipping Address:</span> " . $address . "</p>
                        <p class='text-sm text-gray-600'><span class='font-semibold'>Payment Method:</span> " . $paymentMethod . "</p>
                    </div>
                </div>
        ...
        echo "<p class='text-red-500'>There was an error processing your order: " . $e->getMessage() . "</p>";
    }
}
?>
